...
--
-- Host: 127.0.0.1
-- Tempo de geração: 11/09/2026 às 15:05
...
(5, 'assets/img/Revitalizacao-quadra-poliesportiva-do-CEU-Parque-Sao-Miguel.jpeg', 'quadra ficticia', 'poliesportiva', 'rua dos bobos, n°00', '10:00:00', '22:00:00');
...
CREATE TABLE `reservas` (
  ...
  `esporteReserva` varchar(50) DEFAULT NULL,
...
INSERT INTO `reservas` (`idReserva`, `idReservante`, `idQuadraReservada`, `dataReserva`, `horarioInicio`, `horarioFim`, `esporteReserva`, `statusReserva`) VALUES
(2, 1, 2, '2026-08-24', '21:00:00', '23:00:00', 'Futsal', 'concluída'),
(4, 7, 1, '2026-09-09', '11:00:00', '13:00:00', 'Volêi', 'concluída'),
(6, 1, 1, '2026-09-09', '14:00:00', '16:00:00', 'Volêi', 'cancelada'),
(7, 7, 1, '2026-08-08', '10:00:00', '11:00:00', 'Basquete', 'concluída'),
(9, 7, 1, '2026-08-31', '12:00:00', '13:00:00', 'Futsal', 'concluída'),
(10, 7, 1, '2026-09-28', '14:00:00', '16:00:00', 'Queimada', 'agendado');
...
(1, '13300080900', 'Cesar Augusto', '2008-05-02', '42998069904', 'cesaraugusto@gmail.com', '281d5cbef8ded4e9bee409e3b9c67ab2', 'administrador'),
(3, '48260112965', 'Miguel Gustavo', '2009-04-02', '42998643553', 'miguelgustavo@gmail.com', 'a5aad544b38a088b35b395645efe0d61', 'usuario'),
(4, '36528291900', 'Alan de Souza Vanes', '2008-06-06', '66996309666', 'alan@gmail.com', '564f4bcd11273b8ea6b49fbe2dc2ad1c', 'usuario'),
...
--
ALTER TABLE `quadras`
  MODIFY `idQuadra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
